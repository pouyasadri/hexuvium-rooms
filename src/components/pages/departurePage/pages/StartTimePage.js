export default function StartTimePage({isStartTime}){
    return(
        <div className={isStartTime === false ? "hidden" : ""}>
            <div className={"flex justify-center items-center p-3 gap-5 mt-4 bg-blue-300 bg-opacity-40 rounded"}>
                <img width="64" height="64" src="https://img.icons8.com/dusk/64/expired.png" alt="expired"/>
                <p className={"text-center text-neutral-600"}>Departure time</p>
            </div>
